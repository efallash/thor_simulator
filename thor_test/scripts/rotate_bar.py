...
#    rotate_bar.py: Script to pick a bar, rotate it and place it in its original position.
...
orient_rotated = Quaternion(*tf.transformations.quaternion_from_euler(0, 0, 0))
...
place = Pose(Point( 0.45, 0, 0.151), orient_rotated)
